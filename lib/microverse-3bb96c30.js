...
//-- ThreeVisible  -------------------------------------------------------------------------
//------------------------------------------------------------------------------------------
const PM_ThreeVisible = superclass => class extends (0,_croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.PM_Visible)(superclass) {
...
const PM_ThreeCamera = superclass => class extends (0,_croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.PM_Camera)(superclass) {
    constructor(...args) {
        super(...args);
...
class ThreeRenderManager extends _croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.RenderManager {
...
class AvatarActor extends (0,_croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.mix)(_card_js__WEBPACK_IMPORTED_MODULE_4__.CardActor).with(_croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.AM_Player) {
    ...
    getLookFromAnchor() {
        ...
        let lookOffset = anchorData.lookOffset == undefined ? (0,_croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.v3_zero)() : anchorData.lookOffset;
    ...
    goToStep(delta, t) {
        ...
        if (this.lookStart && this.lookEnd) {
            ...
            let lookOffset = (0,_croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.v3_lerp)(this.lookStart.lookOffset, this.lookEnd.lookOffset, t);
    ...
    addOrCycleGizmo(data) {
        ...
        if (!this.gizmo) {
            ...
            this.gizmo = this.createCard({
                translation: (0,_croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.m4_getTranslation)(target.global),
                name: 'gizmo',
...
class AvatarPawn extends (0,_croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.mix)(_card_js__WEBPACK_IMPORTED_MODULE_4__.CardPawn).with(_croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.PM_Player, PM_SmoothedDriver, _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.PM_ThreeVisible, _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.PM_ThreeCamera, _Pointer_js__WEBPACK_IMPORTED_MODULE_3__.PM_Pointer) {
    ...
    showSettingsMenu() {
        let promise = new Promise((resolve, _reject) => {
            let showcase = _croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.Constants.ShowCaseSpec;
...
class CardActor extends (0,_croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.mix)(_croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.Actor).with(_croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.AM_Smoothed, _Pointer_js__WEBPACK_IMPORTED_MODULE_2__.AM_PointerTarget, _code_js__WEBPACK_IMPORTED_MODULE_6__.AM_Code) {
    ...
    */
    ...
    rotateBy(amount) {
        ...
        let q = amount.length === 3 ? (0,_croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.q_euler)(...amount) : amount;
...
class ScriptingBehavior extends Model {
    ...
    setCode(string) {
        ...
        let cls;
        try {
            const Microverse = {..._croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__, ..._ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__, ..._physics_js__WEBPACK_IMPORTED_MODULE_2__, ..._frame_js__WEBPACK_IMPORTED_MODULE_3__, RAPIER: _physics_js__WEBPACK_IMPORTED_MODULE_2__.Physics, getViewRoot};
...
class DolbyChatManager extends _croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.ViewService {
    constructor(name) {
...
`;
    ...
    setMyPosition() {
        ...
        if (this.myLastPosition) {
            ...
            moved = !(0,_croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.v3_equals)(pos, newPos) || !(0,_croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.q_equals)(rot, newRot);
        }
        this.myLastPosition = { pos: newPos, rot: newRot };
        if (moved) {
            const [x, y, z] = newPos;
            const myPosition = { x, y, z };
            const yaw = (0,_croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.q_yaw)(newRot) * 180 / Math.PI;
...
class MyModelRoot extends _croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.ModelRoot {
    ...
    init(options, persistentData) {
        ...
        if (_croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.Constants.ShowCaseSpec) {
...
class MyViewRoot extends _croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.ViewRoot {
    static viewServices() {
        ...
        if (window.settingsMenuConfiguration?.voice ||
            _croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.Constants.ShowCaseSpec && _croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.Constants.ShowCaseSpec.voiceChat) {
    ...
    constructor(model) {
        ...
        if (_croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.Constants.ShowCaseSpec && !model.persistentDataDisabled) this.publish(this.sessionId, "setPersistentDataFlag", false);
...
async function launchMicroverse() {
    if (window.microverseInitFunction) {
        return window.microverseInitFunction(startWorld, { Constants: _croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.Constants, App: _croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.App });
    }
    ...
    if (!basename.endsWith(".vrse")) {
        ...
        if (!_croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.Constants.SystemBehaviorModules) {
            ...
            if (!_croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.Constants.ExcludedSystemBehaviorModules && !_croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.Constants.IncludedSystemBehaviorModules) {
                ...
                if (_croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.Constants.IncludedSystemBehaviorModules) {
                    systemBehaviorModules.push(..._croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.Constants.IncludedSystemBehaviorModules);
                }
                _croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.Constants.SystemBehaviorModules = systemBehaviorModules;
            }
        }
    } else {
